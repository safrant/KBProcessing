...
#include <stdio.h>
#include <string.h>
#include <stdlib.h>		// line required for malloc/free, entered by GF
#include "porterExtern.h"	// line entered to create lib
...
void step1c(void) { if (ends("\01" "y") && vowelinstem()) b[k] = 'i'; }
